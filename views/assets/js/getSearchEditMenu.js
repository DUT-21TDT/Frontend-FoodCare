        ...
        for (let i = (pageNumber - 1) * pageSize; i < (pageNumber - 1) * pageSize + pageSize; i++) {
            if (i < data.length) {
                ...
                <li data-foodid="${data[i].foodid}"
                  ...
                  <div class="EYM_body__right-bottom--img">
                    <img src="${data[i].foodimage}" alt="" id="foodImageId${data[i].foodid}">
                    <i class="fa-solid fa-circle-plus EYM_body__right-bottom--icon Add"></i>
                  </div>
...
$(document).ready(async function () {
    ...
    $('.create_result-container').on('click', '.EYM_body__right-bottom--img img', function () {
